...
const getInfo = async(Event)=>{
    ...
    if(cityVal ===""){
        ...
        try{
            let url =`https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=19415e43365769f2b921311acd031bb9`
            ...
            if (tempMood==='Clear'){
                ...
                "<i class='fa-solid fa-sun-bright' style='color:#eccc68;'></i>"; 
            }
